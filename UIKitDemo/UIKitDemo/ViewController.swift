...
class ViewController: UIViewController {
    ...
    @IBAction func clickCompenents(_ sender: Any) {
//        let componentTableViewController = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "ComponentTableViewController")
    }
